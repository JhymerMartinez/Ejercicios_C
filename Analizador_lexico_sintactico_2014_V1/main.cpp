...
const int I = 100;
const int J = 100;
const int EXT_CADENA = 500;
const int EXT_RANGO = 3;
const int EXT_RESULTADOS = 50;
...
void obtener_tablas(string matriz[I][J], string matriz_tabla1[I][J], string matriz_tabla2[I][J], int rango[EXT_RANGO]) {
...
//en el proximo ciclo 
int recuperar_valor(int valor, int verificador, int retorno, string matriz_tabla1[I][J], string matriz_tabla2[I][J], int rango[EXT_RANGO]) {
...
void algoritmo_validar(string matriz[I][J], string matriz_tabla1[I][J], string matriz_tabla2[I][J], int rango[EXT_RANGO], string palabra) {
...
void presentar_tablas(string matriz[I][J], string matriz_tabla1[I][J], string matriz_tabla2[I][J], int rango[EXT_RANGO]) {
...
int main() {
    string matriz[I][J];
    string matriz_tabla1[I][J];
    string matriz_tabla2[I][J];
    string palabra;
    int rango[EXT_RANGO];
